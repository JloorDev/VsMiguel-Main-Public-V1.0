...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bgBlack:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('menuBlack'));
		bgBlack.scrollFactor.set(0, yScroll);
		bgBlack.setGraphicSize(Std.int(bgBlack.width * 1.175));
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Vs. Miguel v0.1.0", 12);
